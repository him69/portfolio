        ...
        <div className="myFeature md:flex block md:justify-between container mx-auto md:absolute relative md:left-1/2 md:right-1/2 md:-translate-x-1/2 translate-y-24" style={{ top: '18%' }}>
          <div className="md:w-1/3  pBgColor p-12 p-6 mx-4 my-8 md:my-0">
            <div className="flex justify-between">
              ...
              <div> <p className='text-xl mb-4 uppercase'>Sharp Observations</p> <p>I offer insights to enhance website and app usability. By understanding user needs, I provide suggestions for smoother navigation and better experiences.</p></div>
            </div>
          </div>
          <div className="md:w-1/3  pBgColor p-12 p-6 mx-4 my-8 md:my-0">
            <div className="flex justify-between">
              <div className='icon pTextColor mr-4'>icon</div>
              <div> <p className='text-xl mb-4 uppercase'>Attention to Details</p> <p>I believe that the little things matter. So ,i pay close attention to every detail, like colors , fonts,and spacing. By getting these small things right,i ensure that the overall design looks polished and professional.</p></div>
            </div>
          </div>
          <div className="md:w-1/3  pBgColor p-12 p-6 mx-4 my-8 md:my-0">
            <div className="flex justify-between">
              <div className='icon pTextColor mr-4'>icon</div>
              <div> <p className='text-xl mb-4 uppercase'>Continuous Improvement </p> <p>I'm always looking fofr ways to make my code and designs better, even if it's just by 1% whether it's tweaking code for efficiency or refining design elements for clarity, i'm committed to constantly imprving my works. This helps me stay on top of the latest trends and deliver the best possible results.</p></div>
            </div>
          </div>
        </div>
